...
public class AssetsResource {
  ...
  public CompletionStage<Response> replace(@PathParam("id") String id,
    ...
    var content = new org.lawfulevil.inventory.impl.bus.DefaultAssetContent(name, type, body,
        lat != null && lng != null
            ? java.util.Optional.of(new org.lawfulevil.inventory.api.LatLong(lat, lng))
